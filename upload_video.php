...
if (!isset($_POST['obra_id']) || !isset($_POST['cidade']) || !isset($_FILES['videos'])) {
...
$upload_dir = "evidencias/" . $cidade . "/Videos";
...
$extensoes_permitidas = ['mp4', 'avi', 'mov', 'wmv', 'flv', 'mkv', 'webm', 'm4v', 'mpeg', 'mpg'];
...
if (count($uploaded_files) > 0) {
    $message = count($uploaded_files) . " vídeo(s) enviado(s) com sucesso";
    if (count($errors) > 0) {
