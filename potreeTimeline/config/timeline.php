 ...
 * Arquivo único: mantenha uma versão no PC e outra no servidor, ou use $ENVIRONMENT.
 */

// Ajuste os paths para seu ambiente (PC ou servidor)
$CONFIG = [
    'jsonProjetos' => __DIR__ . '/../data/projetos.json',
    'baseProjetos' => '../projetos/Juatuba',
    'suffixPotree' => '2_densification/point_cloud/potree',
];
